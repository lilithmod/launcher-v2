...
const ErrorComp = (props: { open: any; setOpen: any; content: any }) => {
	return (
				...
				<div className='flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
					...
					<Transition.Child
						...
						<div className='inline-block align-bottom bg-neutral-800 border border-neutral-700 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6'>
							<div>
								<div
									className={'mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-600'}>
									{props.content.icon}
								</div>
								<div className='mt-3 sm:mt-5'>
									...
									<div className='mt-2'>
										<p tw='text-xs mb-2 text-neutral-300 text-center'>
											Click the button below to copy the full error to your clipboard, and ask in{' '}
											<code>#community-support</code> for help. Lilith will now shutdown to avoid
											further issues.
										</p>
										<code>
											<p tw='rounded p-2 bg-neutral-900 text-sm text-neutral-400 overflow-scroll'>
